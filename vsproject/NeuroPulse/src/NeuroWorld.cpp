	...
	systems()
{
	...
	rm->registerType( "RawEnergy", "Energy generated by Nodes.");
	rm->registerType( "SexyEnergy", "Processed energy that most Constructs require to run.");
	rm->registerType( "Instruction", "Instructions can do things...");
