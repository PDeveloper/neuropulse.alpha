	...
	systems()
{
	...
	rm->registerType( "Energy", "Energy generated by Nodes.", Ogre::ColourValue( 0.0, 0.0, 1.0));
	rm->registerType( "Power", "Processed energy that most Constructs require to run.", Ogre::ColourValue( 0.2, 0.2, 1.0));
